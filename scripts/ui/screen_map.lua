...
function M.create(state, params, r)
    ...
    -- 完全重写 RenderModalContent —— 原版会画 alpha=180 的全黑遮罩，
    -- 且 monkey-patch 需要调两次 origRender 导致遮罩叠加变全黑。
    -- 这里复制原版流程，将遮罩/背景/边框替换为游戏 Theme 颜色。
    modal_.RenderModalContent = function(self, nvg)
        ...
        -- ① 遮罩：使用游戏 Theme 的 bg_overlay（半透明，不再全黑）
